...
module ChangeBufferHandle =
    ...
    let run() =
        ...
        let t0 = runtime.PrepareTexture (FileTexture(@"E:\Development\WorkDirectory\DataSVN\pattern.jpg",true)) :> ITexture
        let t1 = runtime.PrepareTexture (FileTexture(@"E:\Development\WorkDirectory\DataSVN\grass_color.jpg",true)) :> ITexture
